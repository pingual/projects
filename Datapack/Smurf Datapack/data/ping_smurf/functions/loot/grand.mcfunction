...
execute as @s at @s if score Rand GrandSmurf matches 0 run function ping_smurf:loot/grand1
execute as @s at @s if score Rand GrandSmurf matches 1 run function ping_smurf:loot/grand2
