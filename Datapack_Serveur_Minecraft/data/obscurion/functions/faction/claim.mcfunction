...
execute at @e[tag=non_id] if block ~ 319 ~ light unless block ~ 319 ~ light[level=15] run title @s title "ERREUR, le chunk est déjà claim!"
execute as @e[tag=non_id] at @s if block ~ 319 ~ light unless block ~ 319 ~ light[level=15] run kill @s
tag @e[tag=non_id] remove non_id
execute as @e[tag=Claim,tag=Pingual] if score ClaimDispo Pingual matches 1.. run function obscurion:faction/nomansland
execute as @e[tag=Claim,tag=Survivor] if score ClaimDispo Survivor matches 1.. run function obscurion:faction/nomansland
execute as @e[tag=Claim,tag=Nathfirex] if score ClaimDispo Nathfirex matches 1.. run function obscurion:faction/nomansland
execute as @e[tag=Claim,tag=Le_Buildist] if score ClaimDispo Le_Buildist matches 1.. run function obscurion:faction/nomansland
execute as @e[tag=Claim,tag=Chica] if score ClaimDispo Chica matches 1.. run function obscurion:faction/nomansland
execute as @e[tag=Claim,tag=GrandSaule] if score ClaimDispo GrandSaule matches 1.. run function obscurion:faction/nomansland
execute at @e[tag=Claim,tag=Pingual] if score ClaimDispo Pingual matches 1.. run fill ~ 319 ~ ~15 319 ~15 light[level=1]
execute at @e[tag=Claim,tag=Survivor] if score ClaimDispo Survivor matches 1.. run fill ~ 319 ~ ~15 319 ~15 light[level=2]
execute at @e[tag=Claim,tag=Nathfirex] if score ClaimDispo Nathfirex matches 1.. run fill ~ 319 ~ ~15 319 ~15 light[level=3]
execute at @e[tag=Claim,tag=Le_Buildist] if score ClaimDispo Le_Buildist matches 1.. run fill ~ 319 ~ ~15 319 ~15 light[level=4]
execute at @e[tag=Claim,tag=Chica] if score ClaimDispo Chica matches 1.. run fill ~ 319 ~ ~15 319 ~15 light[level=5]
execute at @e[tag=Claim,tag=GrandSaule] if score ClaimDispo GrandSaule matches 1.. run fill ~ 319 ~ ~15 319 ~15 light[level=6]
